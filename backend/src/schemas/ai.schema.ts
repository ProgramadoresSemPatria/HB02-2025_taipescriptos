...
// Schema para body de geração de todos os materiais juntos
export const generateAllBodySchema = z.object({
  text: z
    .string()
    .min(1, 'Texto é obrigatório')
    .max(5000, 'Texto não pode ter mais que 5000 caracteres'),
...
export type GenerateAllBody = z.infer<typeof generateAllBodySchema>
...
// Schema Swagger para gerar todos os materiais juntos
export const generateAllSchemaSwagger = {
  tags: ['AI'],
  description:
    'Gera quiz, flashcards e sumário juntos e salva no banco de dados',
  security: [{ bearerAuth: [] }],
  body: {
    type: 'object',
    properties: {
      text: {
        type: 'string',
        description: 'Texto para gerar materiais de estudo',
        minLength: 1,
        maxLength: 5000,
      },
      image: {
      ...
      pdfTextChunks: {
        type: 'array',
        description: 'Array de chunks de texto extraídos de PDF (opcional)',
        items: {
          type: 'string',
          maxLength: 4000,
        },
      ...
      quantidadeQuestoes: {
        type: 'number',
        description: 'Quantidade de questões do quiz',
        minimum: 1,
        maximum: 20,
        default: 5,
      },
      quantidadeFlashcards: {
        type: 'number',
        description: 'Quantidade de flashcards',
        minimum: 1,
        maximum: 30,
        default: 10,
      },
      ...
      temperatura: {
        type: 'number',
        description: 'Temperatura para criatividade da IA',
        minimum: 0,
        maximum: 2,
        default: 0.3,
      },
  ...
  response: {
    200: {
      description: 'Materiais de estudo gerados e salvos com sucesso',
      type: 'object',
      properties: {
        quiz: {
          type: 'object',
        ...
        flashcards: {
          type: 'object',
          description: 'Flashcards gerados',
          properties: {
            flashcards: {
              type: 'array',
              items: {
        ...
        material: {
          type: 'object',
          description: 'Dados do material salvo no banco',
          properties: {
            id: { type: 'string' },
            title: { type: 'string' },
            content: { type: 'string' },
